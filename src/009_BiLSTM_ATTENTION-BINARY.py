"""
Description: This script is used to train BiLSTM with Attention Binary Classifier for Toxicity Classification
...
model_path = "../models/BiLSTM_ATTENTION_BINARY/"
model_name = "01_BiLSTM_ATTENTION_Glove_BINARY"
# model_name = "02_BiLSTM_ATTENTION_FT_BINARY"
...
tf.keras.utils.plot_model(
    model_BiLSTM,
    to_file=f"{model_path}{model_name}_architecture.png",
    show_shapes=False,
