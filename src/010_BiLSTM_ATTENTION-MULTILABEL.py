"""
Description: This script is used to train BiLSTM with Attention Multilabel Classifier for Toxicity Classification
...
print('Loading Only toxic Data')
dev = pd.read_csv(data_folder + "/only_toxic_data.csv")
print('Done Only toxic  Data')

required_cols = ['id', 'comment_text', 'cleaned_comment_text', 'toxic', 'severe_toxic', 'obscene', 'threat', 'insult', 'identity_hate']
...
y_train_dev = dev[toxicity_classes]
...
model_path = "../models/BiLSTM_ATTENTION_MULTILABEL/"
# model_name = "01_BiLSTM_ATTENTION_Glove_MULTILABEL"
model_name = "02_BiLSTM_ATTENTION_FT_MULTILABEL"
...
def softmax(x, axis=1):
    ...
    if ndim == 2:
        ...
        raise ValueError('Cannot apply softmax to a tensor of 1D')

d_layer1 = Dense(32, activation = "tanh")
d_layer2 = Dense(1, activation = "relu")
...
x = Bidirectional(LSTM(64, return_sequences=True, dropout=0.1, recurrent_dropout=0.1, kernel_initializer='he_normal'))(x)
...
model_folder = "../models/BiLSTM_ATTENTION_MULTILABEL/"
# model_name = "01_BiLSTM_ATTENTION_Glove_MULTILABEL"
model_name = "02_BiLSTM_ATTENTION_FT_MULTILABEL"
