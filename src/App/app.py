...
model_folder = "./models/"
multilabel_model_name = "01_Multilabel_model"
binary_model_name = "01_Binary_model""
...
# Constants
max_features = 100000      # no. of worlds to embed, rest will be ignored
...
def get_binary_model():
    global binary_model
    binary_model = load_model(f"{model_folder}{binary_model_name}.h5", 
...
def get_multilabel_model():
    ...
    multilabel_model = load_model(f"{model_folder}{multilabel_model_name}.h5", 
                        custom_objects={'f1_m': f1_m,           
                                        'precision_m': precision_m,
                                        'recall_m' : recall_m})
    print("Model Loaded")
